...
<html>
    ...
    <%
       ...
       LinkedList<Usuarios> codigo = new LinkedList<Usuarios>();
        ...
        cambio.Actualizar_contrato(cod);
        inserta.Insertar_pago(plan, cod, contrato.get(0).getPlan_monto());
                ...
                <div class="col s12 m12">
                  <div class="card grey lighten-2">
                    <div class="card-content black-text hoverable center-align">
                      ...
                      <div class="container">
                        <br><br> <br> <br><br> <br>     
                        <a class="btn waves-effect waves-light  light-blue" href="pagos.jsp?email=<%=email%>&niños=<%=niños%>">Regresar</a>
